...
function getTypewriterClass(keyType: KeyType): string {
    switch (keyType) {
        case KeyType.DOT:
            return 'typewriter-dot-key'
        case KeyType.SPACE:
            return 'typewriter-space-key'
        case KeyType.ENTER:
            return 'typewriter-enter-key'
        case KeyType.BACKSPACE:
            return 'typewriter-backspace-key'
        case KeyType.ACTION_KEY:
            return ''
    }
}
...
function getSpecificBootstrapClasses(keyType: KeyType): string {
    switch (keyType) {
        case KeyType.DOT:
            return 'rounded-circle border border-dark mx-1'
        case KeyType.SPACE:
            return 'rounded-pill border border-dark mx-1'
        case KeyType.ENTER:
            return 'rounded-4 border border-dark mx-1'
        case KeyType.BACKSPACE:
            return 'rounded-4 border border-dark mx-1'
        case KeyType.ACTION_KEY:
            return ''
...
function getKeyIcon(key: Key) {
    switch (key) {
        ...
        case Key.DOT3:
            return <FontAwesomeIcon icon={faS} />
        case Key.DOT4:
            return <FontAwesomeIcon icon={faJ} />
        case Key.DOT5:
            return <FontAwesomeIcon icon={faK} />
        case Key.DOT6:
            return <FontAwesomeIcon icon={faL} />
    }
}
...
function getKeyTip(key: Key) {
    switch (key) {
        case Key.SPACE:
            return <div>Espaço</div>
        case Key.ENTER:
            return <div>Q</div>
        case Key.BACKSPACE:
            return <div>Backspace</div>
        default:
            return <div></div>
    }
}
